...
class NotificationHelper
{
    ...
    public static function sendPaymentSuccessfulNotification($user, $order, $amount, $invoice, $transactionId)
    {
        self::sendMail($user, new PaymentSuccessful($user, $order, $amount, $invoice, $transactionId));
    }
}
